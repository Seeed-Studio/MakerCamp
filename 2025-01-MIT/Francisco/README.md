...
<p align="center"><em>Wonderful lighting atmosphere of Shenzhen</em></p>
...
### A Huge Thanks to Cédric Honnet
...
<p align="center" style="float: right; margin-left: 10px;">
  <img src="./images/google_translate.jpeg" alt="Google Translate in action" width="200">
</p>
...
<p align="center">
  <img src="./images/seed1.jpeg" alt="At MIT, we use Seeed Xiaos often for our projects, as depicted on this sample circuit that I milled." width="300">
</p>
<p align="center"><em>We often use Seeed Xiao microcontrollers at MIT for compact, powerful prototypes</em></p>
...
<p align="center">
  <table>
    <tr>
      <td>
        <p align="center">
          <img src="./images/seed2.jpeg" alt="Hardworking Seeed Studio employees, whom I had the privilege to do the hackathon with." width="300">
        </p>
        <p align="center"><em>Hardworking Seeed Studio employees</em></p>
      </td>
      <td>
        <p align="center">
          <img src="./images/seed3.jpeg" alt="Vast array of products that allow the implementation of ML applications." width="300">
        </p>
        <p align="center"><em>Seeed Studio’s wide array of products for ML applications</em></p>
      </td>
    </tr>
  </table>
</p>
...
<div align="center">
  <table>
    ...
    <tr>
      ...
      <td align="center">
        <img src="./images/machines1.jpeg" alt="Quality Control Station" width="260">
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="./images/art1.jpeg" alt="Futuristic Sand Robot" width="280">
        <p><em>Futuristic Sand Robot</em></p>
      </td>
      <td align="center">
        <img src="./images/art2.jpeg" alt="Animatronic Animal Souls" width="280">
        <p><em>Animatronic Animal Souls</em></p>
      </td>
    </tr>
  </table>
</div>
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="./images/art4.jpeg" alt="Dafen Art Village" width="280">
      </td>
      <td align="center">
        <img src="./images/art6.jpeg" alt="Dafen Art Village" width="280">
      </td>
    </tr>
    <tr>
      <td colspan="2" align="center"><em>Dafen Art Village Scenes</em></td>
    </tr>
  </table>
</div>
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="./images/art3.jpeg" alt="Dafen Art Village" width="280">
      </td>
    </tr>
    <tr>
      <td align="center">
        <img src="./images/art5.jpeg" alt="Dafen Art Village" width="280">
      </td>
    </tr>
    <tr>
      <td align="center"><em>Immerse yourself in Dafen’s vibrant atmosphere</em></td>
    </tr>
  </table>
</div>
...
<div align="center">
  ...
  <p><em>Sample business card exchanged on the trip</em></p>
</div>

### Why Connections Matter in Hardware
...
### Building a Robotics Company: The Supply Chain Factor

If I were to create a robotics startup here, I’d rely on a network of:

- **Component Suppliers**  
  From microcontrollers and sensors to motors and actuators, Shenzhen’s markets and industrial parks house nearly everything a robotics startup needs.  
- **Prototyping Services**  
  Rapid prototyping shops are abundant. CNC machining, 3D printing, and PCB assembly often happen under one roof, enabling quick iteration cycles.  
- **Assembly & Manufacturing Facilities**  
  Many factories offer end-to-end solutions, from initial design to final packaging. Having someone introduce me to trusted factory owners or managers would streamline this process and help avoid pitfalls.  
- **Logistics & Distribution**  
  Once the product is ready, an established logistics chain can ship it anywhere in the world. Again, personal recommendations on reliable freight forwarders and couriers can be crucial.
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="./images/hqb1.jpeg" alt="Huaqiangbei Market Overview" width="300">
        <p><em>Huaqiangbei Market Overview</em></p>
      </td>
      <td align="center">
        <img src="./images/hqb3.jpeg" alt="Electronics Shopping at HQB" width="300">
        <p><em>Electronics Shopping at HQB</em></p>
      </td>
    </tr>
  </table>
</div>
...
### A Hardware Lover’s Paradise (With a Few Grey Areas)
...
<div align="center">
  ...
  <p><em>Specialized Components in HQB</em></p>
</div>
...
<div align="center">
  <img src="./images/hqb4.jpeg" alt="Me at HQB" width="500">
  <p><em>Me at HQB</em></p>
</div>
Here are the HQB experts that I'd like to thank:
HQB Experts
Atommann (SZDIY Hackerspace)
Bunnie Huang (Bunnie Studios)
David Cranor (Plus Ultra, Inc)
Jose Angel Torres (Source Parts, Inc)
Matthew Yu (Seeed Studio)
Paul Hamilton (SUSTech, Immersive Design Group)
Ryan Liang (SZDIY Hackerspace)
Terry Given (Tymphany, Ltd)
---
...
<div align="center">
  <img src="./images/hci4.jpeg" alt="Scalable HCI Symposium event" width="500">
  <p><em>Scalable HCI Symposium event card</em></p>
  
  <img src="./images/symp3.jpg" alt="Scalable HCI Symposium event" width="500">
  <p><em>Scalable HCI Symposium MIT team</em></p>
</div>
...
- **Democratizing Hardware Access:** How open hardware movements and Shenzhen’s extensive manufacturing capabilities can bring down barriers—helpful for innovators in both well-resourced and developing regions.  
- **Rapid Prototyping & Iteration:** Lessons on shortening product development cycles by leveraging Shenzhen’s supply chain.  
- **Open Source & Collaboration:** Workshops highlighting best practices for sharing designs, resources, and research findings freely.
...
<div align="center">
  <img src="./images/hack1.jpg" alt="Another team photo" width="500">
  <p><em>Another team photo at the event</em></p>
  
  <img src="./images/symp1.jpeg" alt="My poster" width="500">
  <p><em>Presenting my poster on scalable interfaces</em></p>
</div>
...
1. **Direct Access to Industry Expertise:** Discussions on rapid prototyping and hardware design validated many of my research assumptions.  
2. **Real-World Application Insights:** I gleaned valuable tips on how to maintain cost-effectiveness without sacrificing quality—vital for large-scale or long-term research projects.  
3. **Networking Opportunities:** Connecting with open hardware enthusiasts and academics provided new collaborators who share a passion for iterative, inclusive design.

<br>

<div align="center">
  <img src="./images/symp2.jpg" alt="The whole symposium during a presentation" width="500">
  <p><em>The symposium in full swing—where theory meets practice</em></p>
</div>
...
<div align="center">
  ...
  <p><em>A cute cat I came across while exploring the city</em></p>
</div>
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="./images/food1.jpeg" alt="Delicious Tea" width="300">
        <p><em>Delicious Tea—timed with a small hourglass for perfect steeping</em></p>
      </td>
      <td align="center">
        <img src="./images/food2.jpeg" alt="Street Food Delights" width="300">
        <p><em>A comforting bowl of soup bursting with flavor</em></p>
      </td>
      <td align="center">
        <img src="./images/food3.jpeg" alt="Fine Dining Experience" width="300">
        <p><em>A fine dining experience, courtesy of AIRS</em></p>
      </td>
    </tr>
  </table>
</div>
...
<div align="center">
  ...
  <p><em>Healthcare Facilities in Shenzhen</em></p>
</div>

<br>

### A Fast and Supportive Experience
...
### How It Will Shape My MIT Journey
...
### Looking Ahead: Collaboration & Gratitude
...
- **To the local guides and HQB experts**: Your knowledge of Shenzhen’s hidden gems and insider tips made all the difference.  
- **To the faculty and university researchers**: Thank you for opening your labs and minds to discuss potential collaborations.  
- **To the factory managers and staff**: You brought theories to life, showing me that a strong supply chain and a culture of rapid iteration can launch ideas into the marketplace quicker than I ever imagined.  
- **To Seeed Studio** (and especially Eric Pan) for the heartfelt hospitality and for continually championing open-source solutions.  

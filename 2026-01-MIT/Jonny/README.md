...
It is exciting to be back in China after first visiting in 2018 for factory visits and the production of the [Bird Two Scooter](https://two.bird.co/). It is incredible to see how much China has changed in less than a decade.
...
All the Research at Scale MIT residents participated in the Scalable-HCI conference [Scalable-HCI Conference](https://scalablehci.com/) during the first week. For the HCI conference I sumbitted my work on the P.A.N.D.A. project: a prototype for bio-inspired logistics robots.
...
![sustechrobot](images/susrobot.png)

I went to HK to visit

![APAS](images/apas.png)

**Company Visits**

![UBTech](images/ubtech.png)
